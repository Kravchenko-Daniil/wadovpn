...
TG_PROXY_TEXT = (
    ...
    "Бонус: если нужно срочно поднять только Telegram (без полноценного VPN) — "
    "вот отдельный MTProto-прокси.\n\n"
    "• Маскируется под обычный HTTPS-трафик к Microsoft — DPI не отличает\n"
    "• Работает только в Telegram\n"
    "• Один тап — Telegram сам всё настроит\n\n"
    "Жмите кнопку ниже 👇"
)
