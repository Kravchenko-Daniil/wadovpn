...
PAY_OK_DONATION = (
    ...
    "У тебя бессрочный доступ, деньги пойдут на сервера и развитие."
)

BUY_CHOOSE_DONATION = (
    "💝 **Поддержать проект**\n\n"
    "У тебя уже бессрочный доступ — деньги пойдут на сервера.\n"
    "Выбери сумму:"
)
...
ADMIN_DONATION_NOTIFY = (
    "💝 **Донат от бессрочника**\n\n"
    "Сумма: **{amount} ₽**\n"
    "Юзер: {user_link} (`{tg_id}`)\n"
    "Payment ID: `{payment_id}`\n\n"
    "👉 Пробей чек в «Мой налог»"
